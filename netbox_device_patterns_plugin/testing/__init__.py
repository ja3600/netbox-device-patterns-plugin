"""
Standalone testing base classes for NetBox Device Patterns Plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "netbox_device_patterns_plugin.add_devicepatterns"
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:netbox_device_patterns_plugin:devicepatterns")
        """

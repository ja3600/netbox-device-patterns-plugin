"""
Utility functions for testing NetBox Device Patterns Plugin.
...
def create_test_user(username: str | None = None, permissions: list[str | None] = None,
    ...
    Example:
        ...
        ...     permissions=['netbox_device_patterns_plugin.view_devicepatterns']
        ... )
    """
    if username is None:
...
def post_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        ...
        >>> obj = Devicepatterns.objects.first()
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Devicepatterns.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Devicepatterns': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Devicepatterns.objects.create(name='Test')

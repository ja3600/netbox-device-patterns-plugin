"""
Search indexes for NetBox Device Patterns Plugin.
...
class DevicepatternsIndex(SearchIndex):
    """
    Search index for Devicepatterns model.

    This enables Devicepatterns objects to appear in NetBox's global
    search results.
    """
    ...
    # category = 'NetBox Device Patterns Plugin'

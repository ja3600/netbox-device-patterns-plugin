...
### Release Summary
Initial release of NetBox Device Patterns Plugin. This is a **minor** release introducing basic functionality for managing Device Patterns resources in NetBox.

### Added
- Initial plugin structure with Devicepatterns model
